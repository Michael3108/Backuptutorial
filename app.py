...
# get is activated if there is no data arrived, but when Post data os getting with it, e.x the clicked on the submit button
#then is does something different
